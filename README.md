...
**Latest Enhancements (v0.2.0)**: This version features a completely redesigned WebUI with modern aesthetics, intelligent chapter management for EPUB files, enhanced file organization with automatic folder structuring, and professional-grade interface improvements. The new design includes gradient backgrounds, organized component groups, emoji-enhanced navigation, and optimized layout for improved user experience and productivity.
